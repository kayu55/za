...
HOSTNAME=$(hostname)
REPO="https://raw.githubusercontent.com/kayu55/za/main/"
...
Updatews() {
systemctl stop ws
wget -qO /usr/bin/ws "https://raw.githubusercontent.com/kayu55/za/main/sshws/ws" >/dev/null 2>&1
systemctl start ws
}
setup_data
wget -q https://raw.githubusercontent.com/kayu55/za/main/install/vpn.sh && chmod +x vpn.sh && ./vpn.sh
BUG_FILE="/etc/xray/.bug_optr"
BUG_URL="https://raw.githubusercontent.com/kayu55/za/main/install/bug"
